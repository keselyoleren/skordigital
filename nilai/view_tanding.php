...
<?php
    	//DEFINE Variabel truemerah
			...
			// total niali sudut merah
			$total_nilai_sudut_merah = $totalwasitjuri1merah + $totalwasitjuri2merah + $totalwasitjuri3merah + $totalwasitjuri4merah + $totalwasitjuri5merah;
			...
			// total nilai sudut biru
			$total_nilai_sudut_biru = $totalwasitjuri1biru + $totalwasitjuri2biru + $totalwasitjuri3biru + $totalwasitjuri4biru + $totalwasitjuri5biru;
